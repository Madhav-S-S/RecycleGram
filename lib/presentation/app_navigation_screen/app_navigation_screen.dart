...
class AppNavigationScreen extends StatelessWidget {
                              ...
                              child: Container(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapEmployeeSignupRegisterpage(
                                                  context);
                                            },
                                            child: Container(
                                                decoration:
                                                              ...
                                                              padding:
                                                                  getPadding(
                                                                      ...
                                                                      bottom:
                                                                          10),
                                                              child: Text(
                                                                  "Employee Sign up/Register page",
                                                                  overflow:
                                                                      TextOverflow
                                                                          .ellipsis,
                                                                  textAlign:
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapSignupRegisterpage(context);
                                            },
                                            child: Container(
                                                decoration:
                                                    AppDecoration.fillWhiteA700,
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapCustomerinterface(context);
                                            },
                                            child: Container(
                                                decoration:
                                                    AppDecoration.fillWhiteA700,
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapRegistercomplaint(context);
                                            },
                                            child: Container(
                                                decoration:
                                                    AppDecoration.fillWhiteA700,
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapWorkerinterfaceOne(context);
                                            },
                                            child: Container(
                                                decoration:
                                                    AppDecoration.fillWhiteA700,
  ...
  onTapBiowastedisposal(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.biowasteDisposalScreen);
  }

  onTapBlogsandvideos(BuildContext context) {
  ...
  onTapWorkerhome(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.workerHomeScreen);
  }

  onTapWorkerinterface(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.workerInterfaceScreen);
  }

  onTapWorkerinterfaceOne(BuildContext context) {
